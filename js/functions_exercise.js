 ...
 */
let helloMessage = sayHello("Cole");
...
alert("With your total being $" + billCost + " and tip percentage being " + tipPercent + " you should be tipping $" + calculateTotal);
console.log(calculateTip(billCost, tipPercent));
